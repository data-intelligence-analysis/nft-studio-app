  ...
  return (
    <>
      ...
      <div className="bg-[var(--tw-main-bg-color)]">
        <div className="px-4 py-10 sm:py-10 grid lg:py-12 sm:px-6 sm:grid sm:grid-cols-8 md:grid-cols-10 lg:grid-cols-12 min-h-screen xl:max-w-screen-2xl sm:gap-2 lg:gap-4">
          <div className="h-full py-6 sm:col-span-8 md:col-span-10 lg:col-span-12 xl:col-span-10">
